 ...
 * @author evelyn
 */
@WebServlet(name = "frmJurosCompostos", urlPatterns = {"/juros-compostos.html"})
public class frmJurosCompostos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form action='calc-juros-compostos.html' method='POST'>");            
